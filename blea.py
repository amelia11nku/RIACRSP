...
from blea_statistical_learning import StatisticalLearning
from blea_evolutionary_learning import EvolutionaryLearning
from logger_config import get_logger

# Get logger
logger = get_logger('BLEA')
...
class BLEA:
    ...
    def __init__(self, config=None):
        ...
        """
        # 初始化配置
        self.config = config if config else BLEAConfig()
