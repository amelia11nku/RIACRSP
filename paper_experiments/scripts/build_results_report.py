...
Across Medium and Large instances, the median within-instance seed RPD s.d. for CSG-NI was {variability[('M', CSG)]:.3f} and {variability[('L', CSG)]:.3f} percentage points, respectively, below GA ({variability[('M', 'GA')]:.3f}, {variability[('L', 'GA')]:.3f}), DABC ({variability[('M', 'DABC-RIACRSP')]:.3f}, {variability[('L', 'DABC-RIACRSP')]:.3f}) and LG_HGA ({variability[('M', 'LG_HGA-RIACRSP-v2-N4M')]:.3f}, {variability[('L', 'LG_HGA-RIACRSP-v2-N4M')]:.3f}); DCGA was still less variable despite its poorer objective quality (Supplementary Fig. 2). On Small instances, CSG-NI's median seed RPD s.d. was {variability[('S', CSG)]:.3f}. These are descriptive stability estimates from only five seeds and do not convert low variability into evidence of superior quality.
